...
type Resolvers interface {
	Mutation_generateEmojis(ctx context.Context, times int, length int) ([]data.Emojis, error)
}
...
func (ec *executionContext) _Mutation_generateEmojis(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	args["times"] = arg0
	var arg1 int
	if tmp, ok := field.Args["length"]; ok {
		var err error
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(ctx context.Context) (interface{}, error) {
		return ec.resolvers.Mutation_generateEmojis(ctx, args["times"].(int), args["length"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
type Mutation {
  generateEmojis(times: Int!, length: Int!) : [Emojis!]
}
`)
