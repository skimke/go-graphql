...
import (
	...
	data "github.com/skimke/graphql-app/graphapi/data"
...
type Resolvers interface {
	Mutation_generateEmojis(ctx context.Context, times string) ([]data.Emojis, error)
	Query_emojisList(ctx context.Context) ([]data.Emojis, error)
}
...
var emojisImplementors = []string{"Emojis"}

// nolint: gocyclo, errcheck, gas, goconst
func (ec *executionContext) _Emojis(ctx context.Context, sel []query.Selection, obj *data.Emojis) graphql.Marshaler {
	fields := graphql.CollectFields(ec.Doc, sel, emojisImplementors, ec.Variables)
	...
	for i, field := range fields {
		...
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("Emojis")
		case "text":
			out.Values[i] = ec._Emojis_text(ctx, field, obj)
		default:
...
func (ec *executionContext) _Emojis_text(ctx context.Context, field graphql.CollectedField, obj *data.Emojis) graphql.Marshaler {
...
func (ec *executionContext) _Mutation(ctx context.Context, sel []query.Selection) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "generateEmojis":
			out.Values[i] = ec._Mutation_generateEmojis(ctx, field)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
...
func (ec *executionContext) _Mutation_generateEmojis(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := field.Args["times"]; ok {
		var err error
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(ctx context.Context) (interface{}, error) {
		return ec.resolvers.Mutation_generateEmojis(ctx, args["times"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	for idx1 := range res {
		arr1 = append(arr1, func() graphql.Marshaler {
			...
			rctx.PushIndex(idx1)
			defer rctx.Pop()
			return ec._Emojis(ctx, field.Selections, &res[idx1])
		}())
	}
	return arr1
}
...
func (ec *executionContext) _Query(ctx context.Context, sel []query.Selection) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "emojisList":
			out.Values[i] = ec._Query_emojisList(ctx, field)
		case "__schema":
...
func (ec *executionContext) _Query_emojisList(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	ctx = graphql.WithResolverContext(ctx, &graphql.ResolverContext{
		Object: "Query",
		Args:   nil,
		Field:  field,
	...
	return graphql.Defer(func() (ret graphql.Marshaler) {
		...
		resTmp, err := ec.ResolverMiddleware(ctx, func(ctx context.Context) (interface{}, error) {
			return ec.resolvers.Query_emojisList(ctx)
		})
		if err != nil {
			ec.Error(ctx, err)
			return graphql.Null
...
type Mutation {
  generateEmojis(times: String!) : [Emojis!]
}
`)
